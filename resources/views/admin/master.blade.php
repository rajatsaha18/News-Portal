                ...
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="{{route('subcategory.manage')}}">Manage Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="{{route('news.index')}}">Add News</a></li>
                            <li><a href="{{route('news.manage')}}">Manage News</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
...
<script>
    function getSubCategory(categoryId)
    {
        $.ajax({
            type: "GET",
            url: "{{route('news.get-sub-category')}}",
            data: {id:categoryId},
            datatype: "JSON",
