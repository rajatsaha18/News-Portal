...
{{--                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">--}}
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-5.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
{{--                        <div class="date">--}}
{{--                            <ul>--}}
{{--                                <li>By<a title="" href="#"><span>Jone Kilna</span></a> --</li>--}}
...
{{--                            </ul>--}}
{{--                        </div>--}}
{{--                        <p>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece <a href="#">Read more...</a></p>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="post-style1">--}}
{{--                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">--}}
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-6.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
...
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-7.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
...
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-8.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
...
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-9.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
...
{{--                        <!-- post image -->--}}
{{--                        <a href="#"><img src="{{asset('/')}}website/assets/images/category/category-post-10.jpg" class="img-responsive" alt=""></a>--}}
{{--                    </div>--}}
{{--                    <!-- post title -->--}}
{{--                    <h4><a href="#">There are many variations of passages of Lorem </a></h4>--}}
{{--                    <div class="post-title-author-details">--}}
