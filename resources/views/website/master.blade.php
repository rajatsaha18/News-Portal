...
<!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Oct 2022 05:13:30 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Scrollbar css -->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/css/jquery.mCustomScrollbar.css" />
    <!-- Owl Carousel css -->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/owl-carousel/owl.carousel.css" />
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/owl-carousel/owl.theme.css" />
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/owl-carousel/owl.transitions.css" />
    <!-- youtube css -->
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/css/RYPP.css" />
    <!-- jquery-ui css -->
    ...
    <!-- fonts css -->
    <link rel="stylesheet" href="font-awesome/{{asset('/')}}website/assets/css/font-awesome.min.css">
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}website/assets/css/Pe-icon-7-stroke.css" />
        ...
        <nav class="mobile-menu" id="mobile-menu">
            <div class="sidebar-nav">
                <ul class="nav side-menu">
                    ...
                    <li><a href="http://wdp.joycalls.com/?dest_url=http://news365htmllatest.bdtask.com/Demo/DemoNews365/index.html">Home</a></li>
                    <li>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-4 col-sm-4">
                    <div class="header-logo">
                        <!-- logo -->
                        <a href="{{route('home')}}">
                            <img class="td-retina-data img-responsive" src="{{asset('/')}}website/assets/images/logo.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-xs-8 col-md-8 col-sm-8 hidden-xs">
                    <div class="header-banner">
                        <a href="#"><img class="td-retina img-responsive" src="{{asset('/')}}website/assets/images/top-bannner.jpg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <nav class="navbar">
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle category02" data-toggle="dropdown">ALL News <span class="pe-7s-angle-down"></span></a>
                        <ul class="dropdown-menu menu-slide">
                            @foreach($categories as $category)
                            <li class="dropdown-submenu"><a href="{{route('category',['id' => $category->id])}}">{{$category->name}}</a>
                                <ul class="dropdown-menu zoomIn">
                                    @foreach($category->subcategories as $subcategory)
                                    <li><a href="{{route('subcategory',['id' => $subcategory->id])}}">{{$subcategory->name}}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            @endforeach
{{--                            <li class="dropdown-submenu"><a href="{{route('category')}}">Categories</a>--}}
{{--                                <ul class="dropdown-menu zoomIn">--}}
{{--                                    @foreach($categories as $category)--}}
{{--                                    <li>--}}
...
{{--                    </li>--}}
                    @foreach($categories as $category)
                    <li><a href="{{route('category',['id' => $category->id])}}" class="category04">{{$category->name}}</a></li>
                    @endforeach
{{--                    <li><a href="{{route('news.international')}}" class="category04">International</a></li>--}}
{{--                    <li><a href="{{route('news.sports')}}" class="category05">Sports</a></li>--}}
{{--                    <li><a href="{{route('news.business')}}" class="category06">Business</a></li>--}}
{{--                    <li><a href="{{route('news.opinion')}}" class="category07">Opinion</a></li>--}}
{{--                    <li><a href="{{route('news.youth')}}" class="category08">Youth</a></li>--}}
{{--                    <li><a href="{{route('news.entertainment')}}" class="category08">Entertainment</a></li>--}}
{{--                    <li><a href="{{route('news.lifestyle')}}" class="category08">Lifestyle</a></li>--}}
                    <li class="dropdown">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="footer-box footer-logo-address">
                    <!-- address  -->
                    <img src="{{asset('/')}}website/assets/images/footer-logo.png" class="img-responsive" alt="">
                    <address>
            ...
            <div class="col-sm-4">
                <div class="footer-box">
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="1s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/assets/images/popular_news_01.jpg" alt="" height="80" width="100"></a>
                        </div>
                    ...
                    <div class="box-item wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div class="img-thumb">
                            <a href="#" rel="bookmark"><img class="entry-thumb" src="{{asset('/')}}website/assets/images/popular_news_02.jpg" alt="" height="80" width="100"></a>
                        </div>
                        <div class="item-details">
...
<div class="sub-footer">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <p><a href="http://bdtask.com/" class="color-1">bdtask</a> Theme | All right Reserved 2016</p>
                <div class="social">
                    <ul>
                        <li><a href="#" class="facebook"><i class="fa  fa-facebook"></i> </a></li>
                        <li><a href="#" class="twitter"><i class="fa  fa-twitter"></i></a></li>
...
<script type="text/javascript" src="{{asset('/')}}website/assets/js/metisMenu.min.js"></script>
<!-- Scrollbar js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/jquery.mCustomScrollbar.concat.min.js"></script>
<!-- animate js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/wow.min.js"></script>
<!-- Newstricker js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/jquery.newsTicker.js"></script>
<!--  classify JavaScript -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/classie.js"></script>
<!-- owl carousel js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/owl-carousel/owl.carousel.js"></script>
<!-- youtube js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/RYPP.js"></script>
<!-- jquery ui js -->
<script type="text/javascript" src="{{asset('/')}}website/assets/js/jquery-ui.js"></script>
<!-- form -->
...
<!-- Mirrored from news365htmllatest.bdtask.com/Demo/DemoNews365/home-style-three.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 01 Oct 2022 05:15:55 GMT -->
</html>
