            ...
            <div class="col-sm-8">
                <article class="content">
                    <div class="post-thumb">
                        <img src="{{asset($news->image)}}" class="img-responsive post-image" alt="">
                        <div class="social">
                            <ul>
                    ...
                    <figure class="imgright">
                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/details-02.jpg" alt="">
                    </figure>
                                    ...
                                    <div class="row rn_block">
                                        <div class="col-xs-12 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale.jpg" alt="">
                                                    </a>
                                                </div>
                                        ...
                                        <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale02.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-info meta-info-rn">
                                                    <div class="slide">
                                        ...
                                        <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s" data-wow-delay="0.4s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale03.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-info meta-info-rn">
                                                    <div class="slide">
                                    ...
                                    <div class="row rn_block">
                                        <div class="col-xs-12 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s" data-wow-delay="0.6s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale04.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-info meta-info-rn">
                                                    <div class="slide">
                                        ...
                                        <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s" data-wow-delay="0.8s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale05.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-info meta-info-rn">
                                                    <div class="slide">
                                        ...
                                        <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s" data-wow-delay="1s">
                                                ...
                                                <div class="post-thumb">
                                                    <a href="#">
                                                        <img class="img-responsive" src="{{asset('/')}}website/assets/images/articale06.jpg" alt="">
                                                    </a>
                                                </div>
                                                <div class="post-info meta-info-rn">
                                                    <div class="slide">
                        ...
                        <ul id="comments-list" class="comments-list">
                            <li>
                                <div class="comment-main-level">
                                    <!-- Avatar -->
                                    <div class="comment-avatar"><img src="{{asset('/')}}website/assets/images/comment-01.jpg" class="img-circle" alt=""></div>
                                ...
                                <ul class="comments-list reply-list">
                                    <li>
                                        <!-- Avatar -->
                                        <div class="comment-avatar"><img src="{{asset('/')}}website/assets/images/comment-02.jpg" class="img-circle" alt=""></div>
                                        <!-- Contenedor del Comentario -->
                                        <div class="comment-box">
                                            <div class="comment-head">
